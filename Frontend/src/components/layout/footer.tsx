            ...
            <div className="max-w-7xl px-6 lg:px-12 flex flex-col md:flex-row justify-between items-start z-10 relative">
                ...
                >
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <button onClick={() => scrollToSection('home')} className="text-sm text-neutral-300 hover:text-white text-left transition-colors font-medium">Home</button>
                        <button onClick={() => scrollToSection('projects')} className="text-sm text-neutral-300 hover:text-white text-left transition-colors font-medium">Work</button>
                        <button onClick={() => scrollToSection('about')} className="text-sm text-neutral-300 hover:text-white text-left transition-colors font-medium">About</button>
                        <button onClick={() => scrollToSection('contact')} className="text-sm text-neutral-300 hover:text-white text-left transition-colors font-medium">Contact</button>
                    </div>

                    {/* Socials */}
                    <div className="flex flex-col space-y-4">
                        <h4 className="text-xs text-neutral-500 uppercase tracking-widest mb-1 font-semibold">Socials</h4>
                        <a href={`mailto:${User.contact.email}`} className="text-sm text-neutral-300 hover:text-white transition-colors font-medium">Email</a>
                        <a href={User.social.linkedin} target="_blank" rel="noreferrer" className="text-sm text-neutral-300 hover:text-white transition-colors font-medium">LinkedIn</a>
                        <a href={User.contact.whatsapp} target="_blank" rel="noreferrer" className="text-sm text-neutral-300 hover:text-white transition-colors font-medium">Whatsapp</a>
                        <a href={User.social.github.url} target="_blank" rel="noreferrer" className="text-sm text-neutral-300 hover:text-white transition-colors font-medium">Github</a>
                    </div>
