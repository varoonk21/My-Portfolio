            ...
            >
              <div className="flex justify-end mb-4">
                <button
                  ...
                  className="p-2 -mr-2 -mt-2 cursor-pointer text-neutral-900 hover:text-white"
                >
              ...
              <div className="flex flex-col gap-2 px-2 overflow-y-auto pb-4">
                {links.map((link) => (
                  ...
                  >
                    <span>{link.name}</span>
                    <span className="text-neutral-900/30 text-2xl group-hover:text-neutral-900 transition-colors">
                      +
                    </span>
                  </a>
                ))}
