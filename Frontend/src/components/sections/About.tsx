      ...
      <div className="w-full grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="flex items-center gap-3 mt-8">
            ...
            <div className="active:scale-[0.98] hover:opacity-90 hover:scale-105 font-medium bg-neutral-900 text-white dark:bg-white dark:text-neutral-800 px-6 py-3 rounded-xl flex items-center justify-center transition-all shadow-md group gap-2">
              <Icon icon="mdi:file-document" width="20" />
              <PDFDownloadLink document={<ResumePDF projects={projects} />} fileName="Varoon-Kumar-Resume.pdf">
                {({ loading }) => (loading ? "Preparing Resume..." : "Resume")}
              </PDFDownloadLink>
            </div>
          </div>
        </div>
