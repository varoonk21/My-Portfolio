...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative h-screen max-h-dvh w-full overflow-hidden flex items-center justify-center">
      ...
      <img src="/img/logo.png" alt="VK logo" className="md:hidden  absolute top-2 left-3 w-18 " />

      {/* Left Social Bar */}
      <div className="absolute left-2 md:left-6 bottom-10 flex flex-col items-center gap-6 text-neutral-900 sm:flex">
        <button className="flex items-center group" onClick={() => setShowVideo(true)} title="Play intro video">
          <Icon
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          Frontend Developer <br />& Video Editor
        </motion.h1>
      </div>
