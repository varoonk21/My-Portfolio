...
export default function Contact() {
  ...
  return (
    <section
      className=" bg-[#f0f0f0] text-neutral-800 md:px-16 md:py-20 sm:p-12 p-6 pb-12 dark:bg-[#1e1e1e] dark:text-[#f8f8f8] transition-colors"
      id="contact"
    >
      ...
      <div className="w-full mx-auto grid md:grid-cols-[1fr_1.5fr] gap-4 lg:gap-24 items-start">
        ...
        <div className="flex-1">
          <p className="text-lg my-8 text-neutral-600 leading-relaxed">
          ...
          <a
            ...
            className="flex items-center mt-6 space-x-4 hover:translate-x-1 transition-all duration-200 rounded-lg"
          >
          ...
          <div className="mt-6">
            ...
            <div className="flex mt-4 space-x-4">
              <a
                ...
                aria-label="Visit Varoon Kumar's Github profile"
                target="_blank"
                className="p-3 hover:scale-110 active:bg-transparent dark:hover:text-white dark:active:text-white bg-neutral-200 text-[#3d3d3d] dark:bg-gray-50 rounded-full"
              >
                {/* github */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Visit Varoon Kumar's Linkedin profile"
                target="_blank"
                className="p-3 hover:scale-110 active:bg-transparent bg-neutral-200 dark:hover:text-white dark:active:text-white dark:bg-neutral-50 text-[#3d3d3d] rounded-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Text Varoon Kumar on Whatsapp"
                target="_blank"
                className="p-3 hover:scale-110 active:bg-transparent bg-neutral-200 dark:hover:text-white dark:active:text-white dark:bg-neutral-50 text-[#3d3d3d] rounded-full"
              >
        ...
        <form onSubmit={(e) => formSubmit(e)} className="flex flex-col w-full mt-8 md:mt-0">
          <h3 className="text-2xl font-semibold mb-8 text-center md:text-left text-gray-800 dark:text-gray-100">
            Send Me a Message
          </h3>
          {isSucess && (
            <div className="mb-6">
          ...
          <div className="flex flex-col w-full gap-10">
            ...
            <div className="relative ">
              <label
                htmlFor="name"
                className="absolute -top-3 left-4 bg-[#f0f0f0] dark:bg-[#1e1e1e] px-2 text-sm font-medium text-gray-500 dark:text-gray-400 z-10 transition-colors"
              >
                Name
              </label>
              <input
              ...
              />
              {error.nameError && (
                <p className="text-red-500 mt-1 text-sm absolute -bottom-6 left-2">This field is required</p>
              )}
            </div>
            ...
            <div className="relative ">
              ...
              />
              {error.emailError && (
                <p className="text-red-500 mt-1 text-sm absolute -bottom-6 left-2">{error.emailErrorMessage}</p>
              )}
            </div>
            ...
            <div className="relative ">
              ...
              <textarea
                ...
                placeholder="Hey Varoon, I'd like to discuss a project..."
              ></textarea>
              {error.messageError && (
                <p className="text-red-500 mt-1 text-sm absolute -bottom-6 left-2">This field is required</p>
              )}
            ...
            <button
              ...
              className="self-start w-full active:scale-[0.98] hover:opacity-90 hover:scale-105 font-medium bg-neutral-800 text-white dark:bg-white dark:text-neutral-800 px-8 py-5 rounded-2xl flex items-center justify-center transition-all shadow-md group"
            >
