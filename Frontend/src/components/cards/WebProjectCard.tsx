      ...
      <div className="flex flex-col grow p-5 sm:p-6 w-full">
        <div className="flex justify-between items-center w-full mb-3">
          ...
          <a
            ...
            target="_blank"
            className="p-1.5 sm:p-2 rounded-full bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-500/20 dark:hover:text-blue-300 transition-colors"
          >
            <Icon
        ...
        <div className="flex flex-wrap gap-2 mt-auto pt-2">
          {project.topics
            ...
            .map((tech) => (
              <span
                key={tech}
                className="px-3 py-1.5 rounded-lg text-[11px] sm:text-xs font-semibold bg-neutral-100 text-neutral-700 dark:bg-[#333333]
